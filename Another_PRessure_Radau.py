...
# ================= Параметры системы =================
V_total = 1.30; fill_fraction = 0.18; Q_dot = 30000.0 # Увеличен теплоприток для наглядности
t_end = 500.0

# ================= НАСТРОЙКА ДАВЛЕНИЙ =================
P_init = 7.0 * 1e5    # Начальное давление в резервуаре (5 бар)
P_open = 8.0 * 1e5    # Давление открытия клапана (6 бар)
P_full = 8.6 * 1e5    # Давление полного открытия (обычно +10% от P_open)
